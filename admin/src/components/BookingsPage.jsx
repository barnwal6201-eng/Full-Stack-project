        ...
        async function fetchBookings() {
            ...
            try {
                ...
                const mapped = items.map((b) => {
                    ...
                    const movie = (b.movie && (b.movie.title || b.movie.movieName)) || 
                        b.movieName || 
                        (typeof b.movie === 'string' ? b.movie : "");
                    const rawSlot = b.showtime || b.slot || b.time || b.date;
                    const slot = rawSlot ? new Date(rawSlot) : null;
                    const basePrice = Number(b.basePrice || b.base_price || (b.movie && b.movie.price) || 0) || 0;
                    ...
                    const customer = b.customer || b.customerName || 
                    (b.user && (b.user.name || b.user.fullName)) ||
                    (b.raw && b.raw.customer) || "";

                    let amountRupees = 0;
                    if(b.amountPaisa !== undefined && b.amountPaisa !== null)
                        amountRupees = Number(b.amountPaisa) / 100;
                    else if (typeof b.amount === 'number') amountRupees = b.amount;
                    else if (
                        b.raw && b.raw.amountPaisa !== undefined && b.raw.amountPaisa !== null
                    )
                    amountRupees = Number(b.raw.amountPaisa) / 100;
            ...
            {bookingsToShow.map((b) => {
                ...
                return (
                    <article key={b.id} className={styles2.bookingCard}>
                      <div>
                        <div className='flex flex-start justify-between gap-1.5'>
                            <div className='flex items-center gap-3'>
                                ...
                                <div>
                                    ...
                                    <div className={styles2.bookedByValue}>{b.customer || "-"}</div>
                                </div>
                            </div>
