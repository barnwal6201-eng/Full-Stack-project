...
const Navbar = () => {
    ...
    const NavItem = ({ to, Icon, label, end = false, onClick }) => {
        return (
            <NavLink
                ...
                onClick={onClick}
                className={({ isActive }) => `${styles4.navLinkBase} ${
    ...
    return (
        <nav className={styles4.navbar}>
            ...
            <div className={`${styles4.mobileMenuContainer} ${
                ...
                >
                 <div className={styles4.mobileMenuPanelHeader}>
                    ...
                    <button
                    onClick={close}
                    className='p-2 rounded-full hover:bg-white/5 focus:outline-nune focus:ring-2 focus:ring-red-600'
                    >
                        <X className='w-6 h-5 text-red-200' />
                    </button>
                 </div>
