        ...
        <div className={footerStyles.mainContainer}>
            ...
            <div className={footerStyles.bottomBar}>
                <div className={footerStyles.designedBy}>
                    ...
                    <a href="https://hexagondigitalservices.com/" target='_blank' className={footerStyles.designedByLink}
                    rel='noopener noreferrer'> Hexagon Digital Services</a>
                </div>

                <div className={footerStyles.policyLinks}>
                    {['Privacy Policy', 'Terms of Service', 'Cookie Policy'].map((item, index) => (
                        <a key={index} href="#" className={footerStyles.policyLink}>{item}</a>
                    ))}
                </div>
            </div>
            </div>
