...
const ContactPage = () => {
    ...
    const handleSubmit = (e) => {
      ...
      if(!formData.phone || formData.phone.length !== 10){
        toast.error('⚠️ Please enter a valid 10 digits phone number');
      ...
      window.open(`https://wa.me/${import.meta.env.VITE_WHATSAPP_NUMBER}?text=${whatsappMessage}`,"_blank");
