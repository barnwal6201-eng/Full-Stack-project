...
const VerifyPayementPage = () => {
    const [statusMsg, setStatusMsg] = useState("Verifying status...");
    ...
    useEffect(() => {
     ...
     const verifyPayment = async() => {
        ...
        try {
            ...
            if(status === 404){
                setStatusMsg(
                    serverMsg || "Payement session not found. If you were charged, contact support with your session id."
                );
            }else if(status === 400){
                setStatusMsg(
                ...
                setStatusMsg(
                    serverMsg || "There was an error confirming your payment. If you charged, please contact support."
                )
            }
...
export default VerifyPayementPage
